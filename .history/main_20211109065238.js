...
let readymadeOffset = document.getElementById('portfolio__readymade').getBoundingClientRect().top + offSett;
let processOffset = document.getElementById('portfolio__education-process').getBoundingClientRect().top + offSet;
let finishOffset = document.querySelector('.about').getBoundingClientRect().top + offSet;
